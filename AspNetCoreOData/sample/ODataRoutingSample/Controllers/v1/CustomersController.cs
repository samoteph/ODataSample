...
using Microsoft.AspNetCore.OData.WebHost.Tools;
...
namespace ODataRoutingSample.Controllers.v1
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        //{
        //    bool hasDynamicProperty = options.FilterContainsDynamicProperties();

        //    IQueryable query = null;

        //    if (hasDynamicProperty == false)
        //    {
        //        query = options.ApplyTo(_context.Customers);
        //    }
        //    else
        //    {
        //        query = options.ApplyTo(_context.Customers.ToList().AsQueryable());
        //    }
        ...
        private static IList<Customer> GetCustomers()
        {
            return new List<Customer>
            {
                new Customer
                {
                    ...
                    DynamicProperties = new Dictionary<string, object>(){ { "Age", 40}, {"Nickname","Jon" } }
                },
                new Customer
                {
                    Id = 2,
